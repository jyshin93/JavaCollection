...
public class AddDemo {
	public static void main(String[] args) {
		Vector<String> avengers = new Vector<String>(); //<>사이에는 어떤 타입을 저장할지 적는다.
		//vec.add("홍길동"); 
		//String name = scanner.next(); //위와 같은 내용
		String[] heros = {"iron", "thor", "hulk","hawk"}; //크기가 4인 스트링 배열의 선언과 생성
		...
		// 첫번째 요소 삭제
		avengers.remove(0); // 인덱스값을 파라미터로 전달하면 삭제완료!
